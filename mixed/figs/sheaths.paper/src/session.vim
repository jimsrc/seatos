...
exe 'vert 3resize ' . ((&columns * 108 + 102) / 205)
argglobal
...
silent! normal! zE
let s:l = 90 - ((8 * winheight(0) + 11) / 22)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 162 - ((17 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
162
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 70 - ((35 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 133 - ((0 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
133

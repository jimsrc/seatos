...
#dir_inp         = '../../../ascii/MCflag2/wShiftCorr/_luciano_'
dir_inp         = '../../../ascii/MCflag2/wShiftCorr/bonito'
#fname_inp       = 'MCflag2_2before.4after_fgap0.2_WangNaN'
fname_inp       = 'MCflag2_2before.3after_WangNaN_fgap0.2'
...
#line    = l.split()
varname = 'o7o6' #line[0]       # nombre de la variable
Nfinal  = 55 #int(line[1])  # events w/80%% of data (ESTE ME INTERESA!)
Nselec  = 63 #int(line[2])  # # of selected events
...
TEXT        = 'events w/80%% \nof data: %d'  % Nfinal
TEXT_LOC    = -0.95, 1.2 #stf[varname]['text_loc'] #1.7, 12.0
ylims       = 0.0, 1.5 #stf[varname]['ylims'] #[4., 17.]
ylabel      = 'O7/O6 [1]' #stf[varname]['label'] #'B [nT]'

...
gral                = general()
day                 = 86400.
gral.data_name      = 'McMurdo'
#---- cosas input
gral.fnames = fnames = {}
#fnames[gral.data_name]      = '../../../../../../../data_ace/64sec_mag-swepam/ace.1998-2014.nc'
fnames[gral.data_name]      = '%s/actividad_solar/neutron_monitors/mcmurdo/mcmurdo_utc_correg.dat' % HOME

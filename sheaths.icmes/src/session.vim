...
set shortmess=aoO
badd +118 tt_icme.py
badd +13 ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/shared_lib/shared_funcs.py
badd +108 extract.py
...
badd +92 rebineo_at_sheaths.py
badd +4 ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/shared_lib/ShiftTimes.py
badd +15 ~/ccin2p3/in2p3_data/data_auger/procesamiento/long_trends/code_profiles/cts_temp.corrected/integrated.Eds/src/ch_Eds_smoo2.py
args tt_icme.py
edit tt_icme.py
...
silent! normal! zE
let s:l = 58 - ((42 * winheight(0) + 26) / 53)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 105 - ((30 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
105
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((11 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 475 - ((2 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
475
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 799 - ((6 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
799
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 386 - ((3 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
386
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 64 - ((22 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 87 - ((9 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87

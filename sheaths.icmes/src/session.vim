...
badd +63 ~/ccin2p3/in2p3_data/data_auger/procesamiento/long_trends/code_profiles/cts_temp.corrected/integrated.Eds/src/ch_Eds_smoo2.py
args tt_icme.py
edit tt_icme.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((13 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18

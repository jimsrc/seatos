...
dirs['suffix']      = '_test_dR.mc_'        # sufijo para el directorio donde guardare
                                            # estas figuras
...
#++++ limites
LOW, MID1, MID2, TOP = 0.0, 0.2, 0.3, 3.0 #0.0, 0.3, 0.45, 3.0

emgr.FILTER['filter_dR.icme']    = True
emgr.CUTS['dR_lo'], emgr.CUTS['dR_hi'] = LOW, MID1 #0.0, 0.3 #15.0 # 300.0
emgr.run_all()

emgr.FILTER['filter_dR.icme']    = True
emgr.CUTS['dR_lo'], emgr.CUTS['dR_hi'] = MID1, MID2 #0.3, 0.45
emgr.run_all()

emgr.FILTER['filter_dR.icme']    = True
emgr.CUTS['dR_lo'], emgr.CUTS['dR_hi'] = MID2, TOP #0.45, 3.0
emgr.run_all()
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
emgr.FILTER['filter_dR.icme']    = True
emgr.CUTS['dR_lo'], emgr.CUTS['dR_hi'] = LOW, MID1 #0.0, 0.3
emgr.run_all()

...
for struct in sh.i i; do
    ...
    ./sea_splitted.py -- -ace $ACE -ace1sec 0 -murdo 0 -avr $AVR --rich_csv $RICH_CSV -ahs $HSTS -ahm $HSTS -as $SCLS --dir_plot $dir_out --dir_data $dir_out --suffix _${struct}_ --icme_flag 0.1.2.2H --struct $struct --Vsplit $vsplit --fgap 0.5

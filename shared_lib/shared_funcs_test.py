...
class events_mgr:
    ...
    def load_data_o7o6(self):
        ...
        # doble shift-time.
        #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        print " DATANAME::::  ", self.gral.data_name
        print " FILE::::::::  ", fname_inp
        print " KEYS::::: ", self.f_sc.variables.keys()
    ...
    def filter_events(self):
        ...
        self.rate_pre   = np.array(self.f_events.variables['rate_pre'].data)
        self.Afd        = np.array(self.f_events.variables['A_FD'].data)
        #------------------------------------

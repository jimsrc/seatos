...
silent only
cd ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/mcs/src
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 c_rebineo_luciano.py
badd +498 ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/shared_lib/shared_funcs.py
badd +531 ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/shared_lib/shared_funcs_test.py
badd +33 histos_centrales/src/process.py
badd +48 histos_centrales/src/c_rebineo_test.py
args c_rebineo_luciano.py
edit c_rebineo_luciano.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 94 - ((46 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1023 - ((47 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1023
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 515 - ((15 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
515
...
exe 'vert 3resize ' . ((&columns * 111 + 111) / 223)
argglobal
vnoremap <buffer> 	 :py isort_visual()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 95 - ((22 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 412 - ((15 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
412

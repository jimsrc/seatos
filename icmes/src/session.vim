...
silent! normal! zE
let s:l = 19 - ((17 * winheight(0) + 24) / 49)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 56 - ((2 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 477 - ((25 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
477
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 935 - ((19 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
935
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 515 - ((47 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
515

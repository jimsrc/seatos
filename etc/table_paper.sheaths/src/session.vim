...
silent only
cd ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/etc/table_paper.sheaths/src
...
badd +1 tt2.py
badd +1 tt3.py
badd +24 c_rebineo_group_Vmc.py
badd +1 tt4.py
badd +0 tt5.py
args test.py
edit test.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((3 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 107 - ((36 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107

...
DIR_ASCII = '../../../../sheaths/ascii/MCflag%s/wShiftCorr' % (FILTER['MCwant']) + '/_test_Bmc_'
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
proms = []

CUTS['B_lo'], CUTS['B_hi'] = 0.00, 11.0 #0.00, 10.0
proms += [make_plot(DIR_ASCII, FILTER, CUTS, nBin)]

CUTS['B_lo'], CUTS['B_hi'] = 11.0, 15.0 #10.0, 14.0
proms += [make_plot(DIR_ASCII, FILTER, CUTS, nBin)]

CUTS['B_lo'], CUTS['B_hi'] = 15.0, 300.0 #14.0, 300.0
proms += [make_plot(DIR_ASCII, FILTER, CUTS, nBin)]

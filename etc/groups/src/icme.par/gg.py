...
DIR_ASCII = '../../../mcs/ascii/MCflag%s/wShiftCorr' % (FILTER['MCwant'])
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
proms = []

CUTS['dR_lo'], CUTS['dR_hi'] = 0.00, 0.30
proms += [make_plot(DIR_ASCII, FILTER, CUTS, nBin)]

CUTS['dR_lo'], CUTS['dR_hi'] = 0.30, 0.45
proms += [make_plot(DIR_ASCII, FILTER, CUTS, nBin)]

CUTS['dR_lo'], CUTS['dR_hi'] = 0.45, 3.00
proms += [make_plot(DIR_ASCII, FILTER, CUTS, nBin)]
...
savefig('./test.png', format='png', dpi=135, bbox_inches='tight')
close()

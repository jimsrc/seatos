...
silent only
cd ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/etc/groups/src/for.paper
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Vmc.group_mix.py
args Vmc.group_mix.py
edit Vmc.group_mix.py
...
silent! normal! zE
let s:l = 86 - ((23 * winheight(0) + 20) / 40)

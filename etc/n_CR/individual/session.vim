...
silent only
cd ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/etc/n_CR/individual
...
badd +104 ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/etc/n_CR/share/funcs.py
badd +34 run_brute.py
badd +0 results.txt
args vm_lo.py
edit apply_model.py
...
silent! normal! zE
let s:l = 23 - ((14 * winheight(0) + 22) / 45)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 114 - ((23 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
114
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((16 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 78 - ((9 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
...
exe 'vert 1resize ' . ((&columns * 78 + 76) / 152)
exe '2resize ' . ((&lines * 19 + 24) / 48)
exe 'vert 2resize ' . ((&columns * 78 + 76) / 152)
exe '3resize ' . ((&lines * 15 + 24) / 48)
exe 'vert 3resize ' . ((&columns * 78 + 76) / 152)
exe 'vert 4resize ' . ((&columns * 73 + 76) / 152)
argglobal
vnoremap <buffer> 	 :py isort_visual()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
...
wincmd w
argglobal
edit ~/ASOC_ICME-FD/icmes_richardson/data/mean_profiles/ace/etc/n_CR/share/funcs.py
vnoremap <buffer> 	 :py isort_visual()
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 238 - ((15 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
238
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 167 - ((10 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 167 - ((17 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 17 - ((3 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17

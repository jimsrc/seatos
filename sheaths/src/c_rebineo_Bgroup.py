...
emgr.CUTS['B_lo'], emgr.CUTS['B_hi'] = 0.0, 10.0 #15.0 # 300.0
emgr.run_all()

emgr.FILTER['B_filter']    = True
emgr.CUTS['B_lo'], emgr.CUTS['B_hi'] = 10.0, 15.0
emgr.run_all()

emgr.FILTER['B_filter']    = True
emgr.CUTS['B_lo'], emgr.CUTS['B_hi'] = 15.0, 300.0
emgr.run_all()
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
emgr.FILTER['B_filter']    = True
emgr.CUTS['B_lo'], emgr.CUTS['B_hi'] = 0.0, 10.0
emgr.run_all()
